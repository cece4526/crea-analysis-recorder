...
/**
 * Test unitaire pour l'entité AvCorrectSoja.
 *
 * @category Test
 ...
 */
class AvCorrectSojaTest extends TestCase
{
    /**
     * Teste tous les getters et setters de l'entité AvCorrectSoja.
     *
     * @return void
     */
    public function testGettersAndSetters()
    {
        $entity = new AvCorrectSoja();
        ...
        $entity->setProteine('6.6');
        $this->assertSame('6.6', $entity->getProteine());
    }
}
